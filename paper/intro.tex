...
\begin{figure}[t!]
    ...
    \caption{The MSSP architecture for intrusion detection. The plain-text system logs are first collected in a centralized storage managed by the MSSP. Then these system logs are analyzed for threats. \mati{added "plain-text system logs" in the caption, couldnt fit it in the figure.} }
    \label{mssp}
    \vspace{-2ex}
  \end{figure}  
