...
\begin{itemize}[topsep=.1ex,itemsep=-.1ex,leftmargin=*]
    \item To the best our knowledge, we are the first to introduce a federated provenance graph learning-based IDS, \Sys, which is privacy-preserving, highly scalable, and achieves state-of-the-art detection accuracy.
