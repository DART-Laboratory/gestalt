...
\begin{itemize}[topsep=.1ex,itemsep=-.1ex,leftmargin=*]
    ...
    \item We developed a sophisticated \textit{\wordvec harmonization framework} using a multi-server architecture for secure private aggregation of semantic attributes.
    \item We conduct a comprehensive evaluation of our technique on real-world datasets, showing \Sys's effectiveness in detecting system threats while being scalable and privacy preserving.
\end{itemize}
