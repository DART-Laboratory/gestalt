...
\begin{figure}[t!]
  ...
  \caption{The MSSP architecture for intrusion detection, which is vulnerable to privacy leakage. The plain-text system logs are first collected in a centralized storage managed by the MSSP. Then these system logs are analyzed for intrusions. \wajih{Update this diagram similar to how you did for the poster with adversary image, etc. }}
  \label{mssp}
  \vspace{-4ex}
\end{figure}
