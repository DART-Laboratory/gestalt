...
\begin{enumerate}[itemsep=0.1em, parsep=0em, topsep=0em]
  ...
  \labitem{C3}{itm:c3} {\bf Temporal Misalignment.} Aggregating models trained on temporally diverse data from different clients can result in a loss of crucial temporal information, impairing the creation of a cohesive global model.
