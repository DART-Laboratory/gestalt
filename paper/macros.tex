...
\newcommand{\Sys}{\mbox{\textsc{Mirage}}\xspace}
...
\newcommand{\orthrus}{\textsc{Orthrus}\xspace}
...
\newcommand{\noskipheading}[1]{\noindent\textsc{\underline{#1}}}
\newcommand{\secref}[1]{Section~\ref{#1}}

\newcommand{\ccmark}[1]{\textbf{\textcolor{green!60!black}{#1}}}
\newcommand{\xcmark}[1]{\textbf{\textcolor{red!70!black}{#1}}}
\newcommand{\ycmark}[1]{\textbf{\textcolor{orange!80!black}{#1}}}

\usepackage[table]{xcolor}

\newcolumntype{G}[1]{>{\columncolor{gray!15}\centering\arraybackslash}p{#1}} % Parametric grey column
