...
\subsection{RQ5: Adversarial Attacks Analysis}
...
\begin{figure*}[!t]
  ...
  \hfill
  \caption{Adversarial attacks analysis. \wajih{the font size is not consistent among figures. also the width and hieght of the figures is also not same. Let's not make these mistakes again.}}
  \label{fig:poison}
  \vspace{-3ex}
\end{figure*}
