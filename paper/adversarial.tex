...
\begin{figure*}[!t]
  ...
  \hfill
  \subfloat[Adversarial mimicry attack]{\includegraphics[width=0.3\textwidth]{fig/adversarial.pdf}\label{mimicryattack}}
  \hfill
  \caption{Adversarial attacks analysis. \Fix{size of the font does not match the text of the paper.}}
  \label{fig:poison}
  \vspace{-3ex}
\end{figure*}
