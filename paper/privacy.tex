...
\wajih{Make sure that all the assumptions that you are making below are present in the threat model. Also please use ~\ref{sec:threat} where you are taking about assumptions. For example, non-collusion assumption between utility and central server needs a reference to the section. }
...
\wajih{What is "semantic privacy"?}
\end{proof}

\wajih{You are assuming that clients observe disjoint semantic vocabularies. Is that true? Because there will be overlapping tokens. Can you refer to our design here if we make this assumption in our design or this aligns with our design. }
...
\wajih{I think we discussed that the subsection below does not fit well here. Let's move this to appendix.}
