...
\begin{figure*}[t!]
  ...
  \caption{High Level Architecture of \Sys. \wajih{Give two or three sentences about the overall workflow. Think about what are the inputs, how the inputs are processed, and what are the outputs.}}
  \vspace{-3ex}
  \label{fig:arch}
\end{figure*}
