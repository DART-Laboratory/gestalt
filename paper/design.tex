...
\begin{figure}[t!]
    ...
    \caption{Secure process entity categorization workflow. \wajih{The colors are not consistent with the Figure 2. Also, there is some mismatch between what you presented Figure 2 and Figure 4. Also, I was hoping you can use actual example of two clients A and B that you have in the subsection. This way we might be able to save some space as well. Also, the caption's some words have capital letters and some are not. I am not sure why do keep making these careless mistakes in the paper. }}
    \label{proc:cate}
    \vspace{-3ex}
  \end{figure}
...
As shown in Algorithm~2 and Figure~\ref{proc:cate}, the framework leverages a central utility server to orchestrate the categorization of process entities. Specifically, it proceeds in three main steps:
\begin{enumerate}[itemsep=0.1em, parsep=0em, topsep=0em, leftmargin=*]
