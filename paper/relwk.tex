...
\PP{Federating Learning in Threat Detection} Few PIDS currently utilize federated learning, with most research focusing on Network Intrusion Detection. Notable works include \cite{man2021intelligent}, which proposes FL for IoT threat detection, and \cite{friha20232df}, which introduces a differentially private detection system for industrial IoT. \cite{li2023efficient} presents an efficient network intrusion detection system, while \cite{guo2023new} explores mitigating the impact of non-IID data on FL for intrusion detection. \Sys addresses these challenges using a categorized \gnnshort learning framework and secure semantic vector harmonization. Lastly, \cite{chaabene2023privacy} describes another FL-based system for IoT intrusion detection. Unlike these approaches, \Sys uniquely integrates federated learning with graph-based threat detection, enhancing both accuracy and privacy in diverse enterprise environments.
