...
\PP{Privacy-Enhancing Cryptographic Techniques}Multi-Party Computation (MPC)~\cite{cramer2015secure} and Fully Homomorphic Encryption (FHE)~\cite{armknecht2015guide} are two techniques for enhancing privacy in cryptographic systems. MPC enables a group of parties to compute a function over their inputs while keeping those inputs private. FHE allows for computations on encrypted data. However, these techniques can introduce additional system complexity and scalability issues~\cite{du2001secure,gentry2009fully,asharov2013more} as the interaction required between parties can lead to delays and exponentially growing protocol costs. In contrast, \Sys uses a simple and scalable encryption technique for averaging semantic embeddings. We provide a privacy analysis of this technique in section~\ref{sec:privacy}.
