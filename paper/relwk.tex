...
\wajih{Please finish this. I moved this stuff from intro here so make sure to not completely remove this. }
...
\Fix{Although decentralized IDS like DistDet attempt to address privacy issues by using a Hierarchical System Event Tree (HST) for event storage, they still transmit these HSTs in plaintext, compromising user log privacy.}
