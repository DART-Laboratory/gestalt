...
We discuss RQ6 in Appendix~\ref{sec:resource_consumption}. Additionally, we present a detailed ablation study in Appendix~\ref{app:ablation} on the following metrics: the effect of the number of \gnnshort\ submodels, federated averaging rounds, differential privacy, and the anomaly threshold on detection performance.
...
\subsection{Effectiveness of categorized graph learning \&  \wordvec harmonization}
