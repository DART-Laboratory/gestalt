...
\begin{figure}[!t]
  ...
  \caption{Effect of differential privacy noise on detection. \wajih{dataset name??}}
  \label{epsvsscore}
  \vspace{-2ex}
\end{figure}
