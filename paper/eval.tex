...
\begin{itemize}[leftmargin=*,itemsep=0.1em, parsep=0em, topsep=0em]
  ...
  \item \textbf{RQ8.} What does the ablation study reveal about \Sys's scalability and effectiveness across key factors like \gnnshort submodels, averaging rounds, federated averaging rounds, etc.?
