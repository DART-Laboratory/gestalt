...
%   \end{table}
  ...
  \begin{table}[!t]
    ...
    \begin{tabular}{ | c | c | c | c | c |}
      ...
      \hline
      \multirow{2}{*}{E5-Cadets} & Local & - & - & - \\
      \cline{2-5} 
      & Harmonized & \ETCP & \ETCR & \ETCF \\
      \hline
      \multirow{2}{*}{E5-Theia} & Local & - & - & - \\
      \cline{2-5} 
      & Harmonized & \ETTHP & \ETTHR & \ETTHF \\
      \hline
      \multirow{2}{*}{E5-ClearScope} & Local & - & - & - \\
      \cline{2-5} 
      & Harmonized & \ETClP & \ETClR & \ETClF \\
      \hline
    \end{tabular}
    \label{local:wordvec}
  \end{table}
...
\PP{Anomaly Threshold} This hyperparameter controls the number of alerts generated by \Sys. It determines the trade-off between precision and recall. We use the E5 Cadets dataset to investigate the effects of different anomaly thresholds. Figure~\ref{thresh} illustrates the results.
