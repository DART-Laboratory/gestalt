...
\subsection{Enterprise settings evaluation}
\label{cost_metric}
We analyzed the performance of our system in an enterprise setting using the \optc dataset, which includes a large number of host machines. We compared our system to centralized systems such as Flash and Kairos. The evaluation focused on three key metrics: network overhead, processing overhead, and overall detection performance.
