...
\subsection{Enterprise settings evaluation}
\label{cost_metric}
We analyzed the performance of our system in an enterprise setting using the \optc dataset, which includes a large number of host machines. We compared our system to centralized systems such as \flash and \kairos. The evaluation focused on two key metrics important for scalability: network overhead and processing overhead.
