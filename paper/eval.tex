...
We also present a detailed ablation study in the appendix~\ref{appendix} on metrics such as the effect of the number of hosts, number of \gnnshort submodels, number of federated averaging rounds, and the anomaly threshold on the detection performance.
