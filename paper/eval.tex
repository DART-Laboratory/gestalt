...
We present a detailed ablation study in Appendix~\ref{app:ablation} on the following metrics: the effect of the number of \gnnshort\ submodels, federated averaging rounds, differential privacy, and the anomaly threshold on detection performance.
