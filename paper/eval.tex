...
\Fix{We discuss RQ6 in Appendix~\ref{sec:resource_consumption}. Additionally, we present a detailed ablation study in Appendix~\ref{app:ablation} on the effect of the number of \gnnshort\ submodels, federated averaging rounds, differential privacy, anomaly threshold, and various system event sizes on our system’s scalability.}
...
\begin{table}[!t]
  ...
  \begin{tabular}{cccccccccc}
    \toprule
    \multirow{2}{*}{\textbf{Datasets}} & \multicolumn{3}{c }{\textbf{\optc}} & \multicolumn{3}{c }{\textbf{E3}} & \multicolumn{3}{c }{\textbf{E5}} \\
