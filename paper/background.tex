...
\wajih{Do not introduce your system here yet.}
...
\wajih{This is by far THE most important subsection of your whole paper that specifies that why building an FL-based PIDS is so challenging. I would like concise headings for each paragraph to specify which specific limitation/challenge we are discussing that paragraph.}
...
These challenges significantly impede the application of the federated learning paradigm to existing systems. We have designed \Sys to address and overcome these issues. \wajih{Add a few more lines here about the high-level workflow and architecture of your system. Like all the steps involved. You should also refer to Figure~\ref{fig:arch} as well.}
