...
\begin{figure}[t!]
  ...
  \caption{The figure shows the example of a provenance graph. \wajih{I meant this: "Diamonds, rectangles, and ovals depict sockets, blah, blah, respectively." }}
...
%\wajih{Please use consistent headings with the Introduction section. Also, I feel some of the information is redundant here as we have already explained it in great detail in the introduction section. If you could make these paragraphs shorter that would be great as it could save us a lot of space.}

\wajih{Let's remove these limitations from here. I feel like we have already discussed them in quite detail in the intro section. IMPORTANT: If there is an information here and that information (numbers, experiments, etc.) is not in the intro section, please move that information from here to the intro section.}
